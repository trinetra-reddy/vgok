  ...
  return (
    ...
    <div className="max-w-6xl mx-auto text-center">
      ...
      <p className="text-lg text-gray-700 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="200">
        The VGOK ecosystem is built on two powerful pillars — VGuarantee for transaction security, and the VGOK blockchain framework for powering digital utility, NFTs, and decentralized community governance.
      </p>
    </div>
    ...
    //           <div>
    //             <h3 className="text-xl font-semibold text-gray-800">VGuarantee Platform</h3>
